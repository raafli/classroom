        ...
        <div class="container">
            <div class="row justify-content-center">
                <div class="col-8">
                    <div class="card">
                        <div class="card-body">
                            <h1 class="text-center mb-5">Edit Tugas</h1>
                            <form action="/updatedatatugas/{{ $datass->id }}" method="POST"
                                ...
                                <br><div class="mb-3">
                                    ...
                                    <select class="form-select" @error('mapels_id') @enderror name="mapels_id"
                                        ...
                                        @foreach ($data as $a)
                                            <option value="{{ $a->id }}"<?php if ($datass->mapels_id == $a->id) {
                                                echo 'selected';
                                            } ?>>{{ $a->mapel }}
                                            </option>
                                        @endforeach
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="date" name="dl" class="form-control" id="exampleInputEmail1"
                                        aria-describedby="emailHelp" value="{{ $datass->dl }}">
                                    @error('dl')
                                        <div class="text-danger">
                                            {{ $message }}
                                        </div>
                                    ...
                                    <div class="mb-1">
                                        ...
                                        <br><img class="img mb-3"src="{{ asset('fototugas/' . $datass->foto) }}"

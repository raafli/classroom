                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xl-12">
                        <div class="card mt-5">
                            <div class="card-body">
                                <div class="container">
                                    <br><h1 class="text-center mb-5">Kelas</h1>
                                    <hr>
                                    <a href="/tambahkelas" class="btn btn-success mb-3"><i class="fa-solid fa-plus"></i></a>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    ...
                                                    <td scope="row">
                                                        <a href="/tampilkelas/{{ $row->id }}"
                                                            class="btn btn-warning"><i
                                                                class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                                        <a href="#" class="btn btn-danger deletekelas"
    ...
    <script>
        $('.deletekelas').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletekelas/" + pegawaiid + ""

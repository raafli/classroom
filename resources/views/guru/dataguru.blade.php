                ...
                <div class="container-fluid">
                    ...
                    <div class="col-xl-12">
                        <div class="card mt-5">
                            <div class="card-body">
                                <div class="container">
                                    <br> <h1 class="text-center mb-5">Data guru</h1>
                                    <hr>
                                    <a href="/tambahguru" class="btn btn-success mb-3"><i class="fa-solid fa-plus"></i></a>
                                        ...
                                        <tbody>
                                            ...
                                            @foreach ($data as $row)
                                                <tr>
                                                    <th scope="row">{{ $no++ }}</th>
                                                    <td>
                                                        <img src="{{ asset('fotoguru/' . $row->foto) }}" alt=""
                                                            style="width: 40px">
                                                    </td>
                                                    <td>{{ $row->nip }}</td>
                                                    <td>{{ $row->nama }}</td>
                                                    ...
                                                    <td scope="row">
                                                        <a href="/tampilkandataguru/{{ $row->id }}"
    ...
    <script>
        $('.deleteguru').click(function() {
            ...
            swal({
                    ...
                    text: "Kamu akan menghapus data guru dengan nama " + nama + "",
                    icon: "warning",
                    buttons: true,
                    dangerMode: true,
                })
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deleteguru/" + pegawaiid + ""

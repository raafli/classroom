                        ...
                        <div class="card-body">
                            ...
                            <form action="/updatedataguru/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="nip" readonly class="form-control"
                                        id="exampleInputEmail1" aria-describedby="emailHelp" value="{{ $data->nip }}">
                                    @error('nip')
                                    ...
                                    <div class="mb-3">
                                        <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div class="form-check mb-3">
                                                    <label class="form-check-label" for="flexRadioDefault2">
                                                        <input class="form-check-input" type="radio" name="jeniskelamin"
                                                            ...
                                                            <?php if ($data['jeniskelamin'] == 'perempuan') {
                                                                echo 'checked';
                                                            } ?>>Perempuan
                                                    </label>
                                                    @error('jeniskelamin')
                                                ...
                                                <div class="mb-1">
                                                    <br><label for="exampleInputEmail1" class="form-label">Masukkan
                                                        Foto</label>
